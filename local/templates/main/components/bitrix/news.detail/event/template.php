        ...
        <div class="l-content">
            <div class="news-detail__container">
                ...
                <div class="news-detail__content">
                    ...
                    <div class="news-detail__more"> <a class="news-detail__more--all" href="/events">
                            Вернуться к списку мероприятий <svg width="20" height="7" viewBox="0 0 20 7" fill="none" xmlns="http://www.w3.org/2000/svg">
