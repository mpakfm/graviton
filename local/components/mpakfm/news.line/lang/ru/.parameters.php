...
$MESS ['T_IBLOCK_DESC_FCDATE']             = "Дата создания";
...
$MESS ['T_IBLOCK_DESC_TITLE']              = "Название над списком";
$MESS ['T_IBLOCK_DESC_LIST_CONT']          = "Количество новостей на странице";
$MESS ['T_IBLOCK_DESC_SECTION_ID']         = "Код/ID разделов";
$MESS ['T_IBLOCK_DESC_FILTER_REQUIRED']    = "Фильтр. Обязательные поля";
$MESS ['T_IBLOCK_DESC_IS_ACTIVE_DATE']     = "Активность по датам как фильтр";
